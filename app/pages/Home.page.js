...
class HomePage extends Component {
  render () {
    ...
    return (
      <Home navigation={this.props.navigation} setTitle={setTitle} toggleLanguage={toggleLanguage} currentLanguage={currentLanguage} saveNote={saveNote} notes={notes} setText={setText} title={title} text={text} onAboutPress={this.props.onAboutPress}/>
    );
  }
 }
